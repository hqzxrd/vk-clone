...
const App = () => {
    return (
        <Routes>
            <Route path="*" element={<AuthProvider><NotFound /></AuthProvider>} />
            <Route path='/' element={<Home />} />
            <Route path='/login' element={<LoginForm />} />
            <Route path='/register' element={<CreateUserWrapper />} />
            <Route path='/:userId' element={<AuthProvider><Profile /></AuthProvider>} errorElement={<NotFound />} />
            <Route path='/edit' element={<AuthProvider><ProfileEdit /></AuthProvider>} />
            <Route path='/newsline' element={<AuthProvider><News /></AuthProvider>} />
            <Route path='/messanger' element={<AuthProvider><Messanger /></AuthProvider>} />
            <Route path='/chat/:userId' element={<AuthProvider><UserDialog /></AuthProvider>} />
            <Route path='/friends' element={<AuthProvider><Friends /></AuthProvider>} />
            <Route path='/peoples' element={<AuthProvider><Peoples /></AuthProvider>} />
        </Routes>
    );
};
